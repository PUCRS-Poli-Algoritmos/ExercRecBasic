...
public class DemoRecBasic {
	...
	// S� converte pra bin�rio, mudar ao vivo pra base qualquer...
	// Proposto pelo Jo�o Batista
	...
	public  void floresVaso(int numFlores) {
		if (numFlores > 0) {
			...
			System.out.println("O vaso est� vazio!");
		}
	...
	public static void main(String [] argc) {
		...
		try {
			...
			System.out.println("Somat�rio falhou: Estourou a pilha!");
			System.out.println(exec.getMessage());
		}
		...
		try {
			...
			System.out.println("Somat�rio ou V2 falhou: Estourou a pilha!");
			System.out.println(exec.getMessage());
		}

		System.out.println("\n\n ******Soma o ArrayList (v1 - posi��o, v2 - remove elem, e v3 - copia array):");		
...
//		System.out.println("Nro de iteracoes: " + ex.getContIter());
		...
		arr = ex.geraArray(4);
		ex.resetCont();
		System.out.println("O Maior (4 elementos - v1) de " + arr.toString() + " � " +  ex.findBiggest_v1(arr) );
		ex.resetCont();
		System.out.println("O Maior (4 elementos - v2) de " + arr.toString() + " � " +  ex.findBiggest_v2(arr) );
		arr = ex.geraArray(8);
		ex.resetCont();
		System.out.println("O Maior (8 elementos - v1) de " + arr.toString() + " � " +  ex.findBiggest_v1(arr) );
		ex.resetCont();
		System.out.println("O Maior (8 elementos - v2) de " + arr.toString() + " � " +  ex.findBiggest_v2(arr) );
		arr = ex.geraArray(32);
		ex.resetCont();
		System.out.println("O Maior (32 elementos - v1) de " + arr.toString() + " � " +  ex.findBiggest_v1(arr) );
		ex.resetCont();
		System.out.println("O Maior (32 elementos - v2) de " + arr.toString() + " � " +  ex.findBiggest_v2(arr) );
		arr = ex.geraArray(128);

		ex.resetCont();
		t1.start();

		System.out.println("\n\nO Maior (128 elementos - v1) de " + arr.toString() + " � " +  ex.findBiggest_v1(arr) );
		t1.finish();
		System.out.println("Tempo em segundos: " + t1.getTime());
		...
		System.out.println("O Maior (128 elementos - v2) de " + arr.toString() + " � " +  ex.findBiggest_v2(arr) );
		t1.finish();
		System.out.println("Tempo em segundos: " + t1.getTime());
		...
		System.out.println("\n\n ******Palindrome - v1 e v2:");
		ex.resetCont();
		System.out.println("� palindrome 'a'? " +  ex.isPal_v1("a") );
		ex.resetCont();
		System.out.println("� palindrome 'a'? " +  ex.isPal_v2("a") );
		ex.resetCont();
		System.out.println("� palindrome ''? " +  ex.isPal_v1("") );
		ex.resetCont();
		System.out.println("� palindrome ''? " +  ex.isPal_v2("") );
		ex.resetCont();
		System.out.println("� palindrome 'casa'? " +  ex.isPal_v1("casa") );
		ex.resetCont();
		System.out.println("� palindrome 'casa'? " +  ex.isPal_v2("casa") );
		ex.resetCont();
		System.out.println("� palindrome 'arara'? " +  ex.isPal_v1("arara") );
		ex.resetCont();
		System.out.println("� palindrome 'arara'? " +  ex.isPal_v2("arara") );
		ex.resetCont();
		System.out.println("� palindrome 'cassac'? " +  ex.isPal_v1("cassac") );
		ex.resetCont();
		System.out.println("� palindrome 'cassac'? " +  ex.isPal_v2("cassac") );
		ex.resetCont();
		System.out.println("� palindrome 'mesam'? " +  ex.isPal_v1("mesam") );
		ex.resetCont();
		System.out.println("� palindrome 'mesam'? " +  ex.isPal_v2("mesam") );
		ex.resetCont();
		System.out.println("� palindrome 'ss'? " +  ex.isPal_v1("ss") );
		ex.resetCont();
		System.out.println("� palindrome 'ss'? " +  ex.isPal_v2("ss") );
		...
		try {
		t2.start();
		System.out.println("� palindrome str com 10000? " +  ex.isPal_v1(str) );
		t2.finish();
		System.out.println("Nro de iteracoes: " + ex.getContIter());
		System.out.println("Tempo em segundos: " + t2.getTime());

		t2.start();
		System.out.println("\n� palindrome str com 10000? " +  ex.isPal_v2(str) );
		t2.finish();
		System.out.println("Nro de iteracoes: " + ex.getContIter());
		System.out.println("Tempo em segundos: " + t2.getTime());
		}
